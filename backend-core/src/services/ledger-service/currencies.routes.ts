...
const FALLBACK_CONFIG: Record<string, { displayName: string; symbol: string; custodyType: string; dashboardConfig: object }> = {
  ...
  ZIG: { displayName: "Zimbabwe Gold (ZiG)", symbol: "Z$", custodyType: "bank", dashboardConfig: { minAmount: 10, maxAmount: 999999999, feePercent: 0.5, dailyLimit: 50000000, features: ["local_transfers"] } },
